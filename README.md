...
**Want to learn more about aggregator mode?** Check out the [MCP Aggregator Hub example](./examples/04-mcp-aggregator-hub/) that demonstrates connecting multiple MCP servers through a single Cipher instance.
