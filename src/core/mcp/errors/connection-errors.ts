...
export class ConnectionFailureError extends MCPConnectionError {
	...
	constructor(message: string, serverName: string, attempt = 1, cause?: Error, recoverable = true) {
...
export class ConnectionLostError extends MCPConnectionError {
	...
	constructor(message: string, serverName: string, lastSuccessfulOperation?: Date, cause?: Error) {
...
export class ConfigurationError extends MCPConnectionError {
	...
	constructor(message: string, serverName: string, configField?: string, configValue?: any) {
