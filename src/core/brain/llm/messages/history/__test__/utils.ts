...
export function makeFakeMessage(i = 0, role: 'user' | 'assistant' | 'system' | 'tool' = 'user'): InternalMessage {
  return { role, content: `msg${i}` };
}

export function makeFakeMessages(count = 10, role: 'user' | 'assistant' | 'system' | 'tool' = 'user'): InternalMessage[] {
