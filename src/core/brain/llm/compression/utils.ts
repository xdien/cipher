 ...
 */
export function assignMessagePriorities(messages: EnhancedInternalMessage[]): EnhancedInternalMessage[] {
 ...
 */
export function getPreservableMessages(messages: EnhancedInternalMessage[]): EnhancedInternalMessage[] {
 ...
 */
export function getRemovableMessages(messages: EnhancedInternalMessage[]): EnhancedInternalMessage[] {
    return messages.filter(message => 
        message.preserveInCompression !== true &&
        message.priority !== MessagePriority.CRITICAL &&
        message.role !== 'system'
 ...
 */
export function sortMessagesByRemovalPriority(messages: EnhancedInternalMessage[]): EnhancedInternalMessage[] {
...
export function validateCompressionResult(
    ...
    const criticalMessages = result.compressedMessages.filter(m => m.priority === MessagePriority.CRITICAL);
...
export function calculateCompressionEfficiency(result: CompressionResult): number {
    ...
    const messagePreservation = result.compressedMessages.length / 
