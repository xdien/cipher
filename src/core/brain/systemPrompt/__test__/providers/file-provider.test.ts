...
describe('FilePromptProvider', () => {
  ...
  describe('generateContent', () => {
    ...
    it('should handle file changes when watching is enabled', async () => {
      ...
      let result = await provider.generateContent(mockContext);
      expect(result).toBe(initialContent);
      
      // Update file content and wait a bit for file system
