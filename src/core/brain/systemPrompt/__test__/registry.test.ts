...
describe('DefaultProviderRegistry', () => {
  ...
  describe('register', () => {
    ...
    it('should throw error for invalid type', () => {
      ...
      expect(() => registry.register('', mockGenerator)).toThrow('Provider type must be a non-empty string');
      expect(() => registry.register(null as any, mockGenerator)).toThrow('Provider type must be a non-empty string');
    });
    ...
    it('should throw error for invalid generator', () => {
      ...
      expect(() => registry.register('test', 'not a function' as any)).toThrow('Generator must be a function');
    });
  });
  ...
  describe('create', () => {
    ...
    it('should throw error for unregistered type', async () => {
      ...
      await expect(registry.create(config)).rejects.toThrow("Provider type 'unregistered-type' is not registered");
    });
